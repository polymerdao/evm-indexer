module.exports = class Data1715371643094 {
    name = 'Data1715371643094'
    ...
    async up(db) {
        ...
        await db.query(`CREATE TABLE "recv_packet" ("id" character varying NOT NULL, "dispatcher_address" text NOT NULL, "dispatcher_type" text NOT NULL, "dispatcher_client_name" text NOT NULL, "dest_port_address" text NOT NULL, "dest_channel_id" text NOT NULL, "sequence" numeric NOT NULL, "block_number" numeric NOT NULL, "block_timestamp" numeric NOT NULL, "transaction_hash" text NOT NULL, "chain_id" integer NOT NULL, "gas" numeric, "max_fee_per_gas" numeric, "max_priority_fee_per_gas" numeric, "from" text NOT NULL, CONSTRAINT "PK_79ecca659a764997adc8794f123" PRIMARY KEY ("id"))`)
        await db.query(`CREATE TABLE "write_ack_packet" ("id" character varying NOT NULL, "dispatcher_address" text NOT NULL, "dispatcher_type" text NOT NULL, "dispatcher_client_name" text NOT NULL, "writer_port_address" text NOT NULL, "writer_channel_id" text NOT NULL, "sequence" numeric NOT NULL, "ack_packet_success" boolean NOT NULL, "ack_packet_data" text NOT NULL, "block_number" numeric NOT NULL, "block_timestamp" numeric NOT NULL, "transaction_hash" text NOT NULL, "chain_id" integer NOT NULL, "gas" numeric, "max_fee_per_gas" numeric, "max_priority_fee_per_gas" numeric, "from" text NOT NULL, CONSTRAINT "PK_c5236bd249c16bb655e20660911" PRIMARY KEY ("id"))`)
        await db.query(`CREATE TABLE "acknowledgement" ("id" character varying NOT NULL, "dispatcher_address" text NOT NULL, "dispatcher_type" text NOT NULL, "dispatcher_client_name" text NOT NULL, "source_port_address" text NOT NULL, "source_channel_id" text NOT NULL, "sequence" numeric NOT NULL, "block_number" numeric NOT NULL, "block_timestamp" numeric NOT NULL, "transaction_hash" text NOT NULL, "chain_id" integer NOT NULL, "gas" numeric, "max_fee_per_gas" numeric, "max_priority_fee_per_gas" numeric, "from" text NOT NULL, CONSTRAINT "PK_8f6e435390595b00ff0b476cac1" PRIMARY KEY ("id"))`)
        await db.query(`CREATE TABLE "packet" ("id" character varying NOT NULL, "state" character varying(13) NOT NULL, "source_chain" text, "dest_chain" text, "send_block_timestamp" numeric, "send_tx" text, "recv_tx" text, "write_ack_tx" text, "ack_tx" text, "send_to_recv_time" numeric, "send_to_recv_gas" numeric, "send_to_ack_time" numeric, "send_to_ack_gas" numeric, "send_packet_id" character varying, "recv_packet_id" character varying, "write_ack_packet_id" character varying, "ack_packet_id" character varying, CONSTRAINT "REL_2f849cd746e0708773d46af527" UNIQUE ("send_packet_id"), CONSTRAINT "REL_3aed1702c2c27f733c1c3c0460" UNIQUE ("recv_packet_id"), CONSTRAINT "REL_08ed04d8e5b3a07dbc6468b7bc" UNIQUE ("write_ack_packet_id"), CONSTRAINT "REL_2eb1a0b6e1c9967db3079d80cb" UNIQUE ("ack_packet_id"), CONSTRAINT "PK_0bef789c4d597bd0b7723f6d878" PRIMARY KEY ("id"))`)
        ...
        await db.query(`CREATE TABLE "timeout" ("id" character varying NOT NULL, "dispatcher_address" text NOT NULL, "dispatcher_type" text NOT NULL, "dispatcher_client_name" text NOT NULL, "source_port_address" text NOT NULL, "source_channel_id" text NOT NULL, "sequence" numeric NOT NULL, "block_number" numeric NOT NULL, "block_timestamp" numeric NOT NULL, "transaction_hash" text NOT NULL, "chain_id" integer NOT NULL, "gas" numeric, "max_fee_per_gas" numeric, "max_priority_fee_per_gas" numeric, "from" text NOT NULL, CONSTRAINT "PK_a24fca9f4a7e03ce67d74283613" PRIMARY KEY ("id"))`)
        await db.query(`CREATE TABLE "write_timeout_packet" ("id" character varying NOT NULL, "dispatcher_address" text NOT NULL, "dispatcher_type" text NOT NULL, "dispatcher_client_name" text NOT NULL, "writer_port_address" text NOT NULL, "writer_channel_id" text NOT NULL, "sequence" numeric NOT NULL, "timeout_height_revision_number" numeric NOT NULL, "timeout_height_revision_height" numeric NOT NULL, "timeout_timestamp" numeric NOT NULL, "block_number" numeric NOT NULL, "block_timestamp" numeric NOT NULL, "transaction_hash" text NOT NULL, "chain_id" integer NOT NULL, "gas" numeric, "max_fee_per_gas" numeric, "max_priority_fee_per_gas" numeric, "from" text NOT NULL, CONSTRAINT "PK_d2c6b017f8adebc40c10e3f6db4" PRIMARY KEY ("id"))`)
