import {Entity as Entity_, Column as Column_, PrimaryColumn as PrimaryColumn_, StringColumn as StringColumn_, Index as Index_, ManyToOne as ManyToOne_, BigIntColumn as BigIntColumn_, IntColumn as IntColumn_, OneToOne as OneToOne_, JoinColumn as JoinColumn_} from "@subsquid/typeorm-store"
...
export class SendPacket {
    ...
    @Index_({unique: true})
    @OneToOne_(() => SendPacketFeeDeposited, {nullable: true})
    @JoinColumn_()
    feeDeposited!: SendPacketFeeDeposited | undefined | null
}
