...
export default createSchema((p) => ({
  ...
  ConfirmIbcChannel: p.createTable({
    id: p.string(),
    dispatcherAddress: p.string(),
    dispatcherType: p.string(),
    dispatcherClientName: p.string(),
  ...
  Packet: p.createTable({
    ...
    sendBlockTimestamp: p.int().optional(),
  ...
  Channel: p.createTable({
    ...
    openTryChannelId: p.string().optional().references('TryIbcChannel.id'),
    openAckChannel: p.one('openAckChannelId'),
    openAckChannelId: p.string().optional().references('AckIbcChannel.id'),
    openConfirmChannel: p.one('openConfirmChannelId'),
    openConfirmChannelId: p.string().optional().references('ConfirmIbcChannel.id'),
